...
<tr><td><em>die Kindheit</em></td><td>дитинство</td><td><em>In meiner Kindheit …</em></td></tr>
  ...
  vocab: [
    {
      group: 'Präteritum сильних дієслів',
      items: [
        { de: 'war / waren', uk: 'був / були', ex: 'Ich war krank.' },
        { de: 'hatte / hatten', uk: 'мав / мали', ex: 'Wir hatten keine Zeit.' },
        { de: 'ging / gingen', uk: 'ішов / ішли' },
        { de: 'kam / kamen', uk: 'прийшов / прийшли' },
        { de: 'fuhr / fuhren', uk: 'їхав / їхали' },
        { de: 'sah / sahen', uk: 'бачив / бачили' },
        { de: 'sprach / sprachen', uk: 'говорив / говорили' },
        { de: 'las / lasen', uk: 'читав / читали' },
        { de: 'schrieb / schrieben', uk: 'писав / писали' },
        { de: 'nahm / nahmen', uk: 'брав / брали' },
        { de: 'fand / fanden', uk: 'знайшов / знайшли' },
        { de: 'blieb / blieben', uk: 'залишився / залишилися' },
      ],
    },
    {
      group: 'Оповідь і послідовність',
      items: [
        { de: 'zuerst', uk: 'спочатку' },
        { de: 'dann / danach', uk: 'потім / після цього' },
        { de: 'plötzlich', uk: 'раптом' },
        { de: 'später', uk: 'пізніше' },
        { de: 'schließlich', uk: 'нарешті' },
        { de: 'am Ende', uk: 'у кінці' },
        { de: 'damals', uk: 'тоді, у ті часи' },
        { de: 'als Kind', uk: 'дитиною' },
        { de: 'die Kindheit', uk: 'дитинство' },
        { de: 'die Erinnerung, -en', uk: 'спогад' },
        { de: 'sich erinnern an + Akk.', uk: 'пам’ятати, згадувати' },
        { de: 'erzählen', uk: 'розповідати' },
      ],
    },
    {
      group: 'Події та обставини',
      items: [
        { de: 'beginnen', uk: 'починатися' },
        { de: 'passieren', uk: 'ставатися' },
        { de: 'der Unfall, ¨-e', uk: 'аварія' },
        { de: 'die Verspätung', uk: 'запізнення' },
        { de: 'warten auf + Akk.', uk: 'чекати на' },
        { de: 'verlieren', uk: 'втрачати, губити' },
        { de: 'suchen / finden', uk: 'шукати / знаходити' },
        { de: 'treffen', uk: 'зустрічати' },
        { de: 'umziehen', uk: 'переїжджати' },
        { de: 'müde / zufrieden', uk: 'втомлений / задоволений' },
      ],
    },
  ],
...
<tr><td><em>die Haare</em> (мн.)</td><td>волосся</td><td><em>sich die Haare waschen</em></td></tr>
  ...
  vocab: [
    {
      group: 'Зворотні дієслова',
      items: [
        { de: 'sich waschen', uk: 'митися' },
        { de: 'sich duschen', uk: 'приймати душ' },
        { de: 'sich anziehen / ausziehen', uk: 'одягатися / роздягатися' },
        { de: 'sich beeilen', uk: 'поспішати', ex: 'Beeil dich!' },
        { de: 'sich ausruhen', uk: 'відпочивати' },
        { de: 'sich setzen', uk: 'сідати', ex: 'Setzen Sie sich, bitte.' },
        { de: 'sich fühlen', uk: 'почуватися', ex: 'Ich fühle mich müde.' },
        { de: 'sich treffen', uk: 'зустрічатися' },
        { de: 'sich verspäten', uk: 'запізнюватися' },
        { de: 'sich vorstellen', uk: 'представлятися' },
        { de: 'sich entschuldigen', uk: 'вибачатися' },
        { de: 'sich unterhalten', uk: 'розмовляти, спілкуватися' },
      ],
    },
    {
      group: 'Дієслова з прийменниками',
      items: [
        { de: 'warten auf + Akk.', uk: 'чекати на' },
        { de: 'sich freuen auf + Akk.', uk: 'тішитися з майбутнього' },
        { de: 'sich freuen über + Akk.', uk: 'радіти тому, що сталося' },
        { de: 'sich interessieren für + Akk.', uk: 'цікавитися' },
        { de: 'sich ärgern über + Akk.', uk: 'сердитися на' },
        { de: 'denken an + Akk.', uk: 'думати про' },
        { de: 'sich erinnern an + Akk.', uk: 'пам’ятати про' },
        { de: 'Angst haben vor + Dat.', uk: 'боятися' },
        { de: 'sprechen über + Akk.', uk: 'говорити про' },
        { de: 'helfen bei + Dat.', uk: 'допомагати в чомусь' },
        { de: 'sich bewerben um + Akk.', uk: 'подаватися на посаду' },
        { de: 'sich kümmern um + Akk.', uk: 'піклуватися про' },
      ],
    },
    {
      group: 'Почуття та стан',
      items: [
        { de: 'müde / erholt', uk: 'втомлений / відпочилий' },
        { de: 'nervös / ruhig', uk: 'знервований / спокійний' },
        { de: 'froh / traurig', uk: 'радісний / сумний' },
        { de: 'aufgeregt', uk: 'схвильований' },
        { de: 'gestresst', uk: 'у стресі' },
        { de: 'der Lärm', uk: 'шум' },
        { de: 'die Ruhe', uk: 'спокій, тиша' },
        { de: 'die Angst, ¨-e', uk: 'страх' },
        { de: 'die Freude', uk: 'радість' },
...
<tr><td><em>umstellen</em></td><td>переставляти</td><td>тема опису кімнати</td></tr>
  ...
  vocab: [
    {
      group: 'Genitiv і належність',
      items: [
        { de: 'wessen?', uk: 'чий?' },
        { de: 'des Vaters', uk: 'батька (чоловічий Genitiv)' },
        { de: 'der Mutter', uk: 'матері (жіночий Genitiv)' },
        { de: 'des Kindes', uk: 'дитини (середній Genitiv)' },
        { de: 'der Eltern', uk: 'батьків (множина)' },
        { de: 'wegen + Gen.', uk: 'через' },
        { de: 'trotz + Gen.', uk: 'попри' },
        { de: 'während + Gen.', uk: 'під час' },
        { de: 'statt + Gen.', uk: 'замість' },
        { de: 'der Anfang / das Ende', uk: 'початок / кінець' },
      ],
    },
    {
      group: 'Меблі та розташування',
      items: [
        { de: 'das Regal, -e', uk: 'полиця' },
        { de: 'der Teppich, -e', uk: 'килим' },
        { de: 'der Spiegel, -', uk: 'дзеркало' },
        { de: 'das Bild, -er', uk: 'картина' },
        { de: 'die Wand, ¨-e', uk: 'стіна' },
        { de: 'die Ecke, -n', uk: 'кут' },
        { de: 'die Decke', uk: 'стеля; ковдра' },
        { de: 'der Schrank, ¨-e', uk: 'шафа' },
        { de: 'die Schublade, -n', uk: 'шухляда' },
        { de: 'umstellen', uk: 'переставляти' },
        { de: 'aufräumen', uk: 'прибирати' },
        { de: 'hängen', uk: 'висіти; вішати' },
      ],
    },
    {
      group: 'Причини та обставини',
      items: [
        { de: 'der Regen', uk: 'дощ' },
        { de: 'die Kälte / die Hitze', uk: 'холод / спека' },
        { de: 'der Stau', uk: 'затор' },
        { de: 'die Krankheit, -en', uk: 'хвороба' },
        { de: 'die Pause, -n', uk: 'перерва' },
        { de: 'die Reise, -n', uk: 'подорож' },
        { de: 'der Grund, ¨-e', uk: 'причина' },
        { de: 'deswegen', uk: 'через це' },
        { de: 'trotzdem', uk: 'попри це' },
      ],
    },
  ],
