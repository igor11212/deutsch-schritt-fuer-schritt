export default {
  intro:
    'C1 — рівень стилю. Граматику ви вже знаєте; тепер ідеться про те, щоб обирати з кількох правильних ' +
    'варіантів найдоречніший, розуміти іронію та підтекст, писати щільно й точно. ' +
    'Нижче — два модулі, що найчастіше відрізняють C1 від B2.',
...
ніж стилістично недоречне слово.</p>`,
  ...
  planned: [
    'Модуль 3: Nominalisierung ↔ Verbalisierung (перетворення в обидва боки)',
    'Модуль 4: Funktionsverbgefüge — zur Verfügung stellen, in Betracht ziehen',
    'Модуль 5: Modalpartikeln — doch, ja, wohl, eben, halt, mal',
    'Модуль 6: Wortbildung — префікси, суфікси, складні іменники',
    'Модуль 7: Konnektoren високого регістру: zumal, geschweige denn, insofern',
    'Модуль 8: Textsorten C1 — Stellungnahme, Zusammenfassung, Grafikbeschreibung',
    'Модуль 9: Idiomatik und Kollokationen',
    'Модуль 10: Комплексний тест рівня C1',
  ],
...
Саме тому в газетах поруч стоять <em>sei</em> і <em>hätten</em> — це не помилка, а система.</div>`,
      ...
      {
        title: '3. Три часи непрямої мами',
        html: `
