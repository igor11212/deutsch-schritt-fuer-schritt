export default {
  intro:
    'B2 — рівень, на якому мова стає інструментом думки. Ви вчитеся будувати довгі зв’язні періоди, ' +
    'протиставляти й поступатися, виражати оцінку та ступінь упевненості, переходити з розмовного ' +
    'стилю на письмовий. Нижче — два ключових модулі рівня.',
...
чужу позицію, перш ніж заперечити їй.</p>`,
  ...
  planned: [
    'Модуль 3: Relativsätze з прийменниками, wo-складені та erweiterte Attribute',
    'Модуль 4: Verben mit festen Präpositionen і Präpositionaladverbien (darauf, worauf)',
    'Модуль 5: Temporale und modale Nebensätze: indem, sodass, je … desto',
    'Модуль 6: Konjunktiv II у минулому, Irrealer Vergleich (als ob)',
    'Модуль 7: Textsorten — Leserbrief, Bewerbung, Stellungnahme',
    'Модуль 8: Redewendungen і слововживання: schwierige Wortpaare',
    'Модуль 9: Комплексний тест рівня B2 (усі чотири модулі іспиту)',
  ],
