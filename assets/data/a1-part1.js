...
<em>du</em> незнайомій людині — неввічливо, тож у сумніві обирайте <em>Sie</em>.</div>`,
  ...
  vocab: [
    {
      group: 'Привітання та прощання',
      items: [
        { de: 'Hallo!', uk: 'Привіт! (будь-коли, неформально)' },
        { de: 'Guten Morgen!', uk: 'Доброго ранку! (до ~11:00)' },
        { de: 'Guten Tag!', uk: 'Добрий день! (універсальне формальне)' },
        { de: 'Guten Abend!', uk: 'Добрий вечір! (після ~18:00)' },
        { de: 'Gute Nacht!', uk: 'На добраніч! (лише перед сном)' },
        { de: 'Grüß Gott!', uk: 'Вітаю! (Австрія, Баварія)' },
        { de: 'Servus!', uk: 'Привіт / Бувай! (Австрія, неформально)' },
        { de: 'Auf Wiedersehen!', uk: 'До побачення! (формально)' },
        { de: 'Tschüss!', uk: 'Бувай! (неформально)' },
        { de: 'Bis bald!', uk: 'До скорого!' },
    ...
    },
    {
      group: 'Знайомство',
      items: [
        { de: 'heißen', uk: 'зватися', ex: 'Wie heißen Sie?', exUk: 'Як Вас звати?' },
        { de: 'kommen aus', uk: 'походити з', ex: 'Ich komme aus der Ukraine.', exUk: 'Я з України.' },
        { de: 'wohnen in', uk: 'мешкати в', ex: 'Ich wohne in Wien.', exUk: 'Я мешкаю у Відні.' },
        { de: 'sprechen', uk: 'говорити (мовою)', ex: 'Ich spreche Ukrainisch und Englisch.', exUk: 'Я говорю українською та англійською.' },
        { de: 'lernen', uk: 'вчити', ex: 'Ich lerne Deutsch.', exUk: 'Я вивчаю німецьку.' },
        { de: 'der Name, -n', uk: 'ім’я, прізвище', ex: 'Mein Name ist Petro Kowal.', exUk: 'Мене звати Петро Коваль.' },
        { de: 'der Vorname', uk: 'ім’я' },
        { de: 'der Familienname', uk: 'прізвище' },
        { de: 'die Adresse, -n', uk: 'адреса' },
        { de: 'die Telefonnummer, -n', uk: 'номер телефону' },
        { de: 'Freut mich!', uk: 'Дуже приємно!' },
        { de: 'Wie geht es Ihnen?', uk: 'Як у Вас справи?' },
        { de: 'Danke, gut.', uk: 'Дякую, добре.' },
        { de: 'Entschuldigung!', uk: 'Перепрошую!' },
      ],
    },
    {
      group: 'Країни та мови',
      items: [
        { de: 'die Ukraine', uk: 'Україна', ex: 'Ich komme aus der Ukraine.', exUk: 'Із назвою «Ukraine» вживається артикль!' },
        { de: 'Deutschland', uk: 'Німеччина' },
        { de: 'Österreich', uk: 'Австрія' },
        { de: 'die Schweiz', uk: 'Швейцарія' },
        { de: 'Polen', uk: 'Польща' },
        { de: 'die Türkei', uk: 'Туреччина' },
        { de: 'Deutsch', uk: 'німецька мова' },
        { de: 'Ukrainisch', uk: 'українська мова' },
        { de: 'Englisch', uk: 'англійська мова' },
    ...
    },
    {
      group: 'Числа 0–20',
      items: [
        { de: 'null, eins, zwei, drei', uk: '0, 1, 2, 3' },
        { de: 'vier, fünf, sechs, sieben', uk: '4, 5, 6, 7' },
        { de: 'acht, neun, zehn', uk: '8, 9, 10' },
        { de: 'elf, zwölf, dreizehn', uk: '11, 12, 13' },
        { de: 'vierzehn, fünfzehn, sechzehn', uk: '14, 15, 16 — увага: sechzehn, а не «sechszehn»' },
        { de: 'siebzehn, achtzehn, neunzehn, zwanzig', uk: '17, 18, 19, 20 — увага: siebzehn, а не «siebenzehn»' },
      ],
    },
  ],
  ...
  vocab: [
    {
      group: 'Професії',
      items: [
        { de: 'der Beruf, -e', uk: 'професія', ex: 'Was sind Sie von Beruf?', exUk: 'Хто Ви за професією?' },
        { de: 'der Lehrer / die Lehrerin', uk: 'учитель / учителька' },
        { de: 'der Arzt / die Ärztin', uk: 'лікар / лікарка' },
        { de: 'die Krankenschwester', uk: 'медсестра' },
        { de: 'der Ingenieur / die Ingenieurin', uk: 'інженер / інженерка' },
        { de: 'der Verkäufer / die Verkäuferin', uk: 'продавець / продавчиня' },
        { de: 'der Koch / die Köchin', uk: 'кухар / кухарка' },
        { de: 'der Student / die Studentin', uk: 'студент / студентка' },
        { de: 'der Fahrer / die Fahrerin', uk: 'водій / водійка' },
        { de: 'der Programmierer', uk: 'програміст' },
        { de: 'arbeitslos', uk: 'безробітний' },
        { de: 'in Rente sein', uk: 'бути на пенсії' },
      ],
    },
    {
      group: 'Робота та навчання',
      items: [
        { de: 'arbeiten', uk: 'працювати', ex: 'Ich arbeite bei einer Firma.', exUk: 'Я працюю на фірмі.' },
        { de: 'studieren', uk: 'навчатися в університеті', ex: 'Sie studiert Medizin.', exUk: 'Вона вивчає медицину.' },
        { de: 'die Firma, -en', uk: 'фірма' },
        { de: 'das Büro, -s', uk: 'офіс' },
        { de: 'das Krankenhaus', uk: 'лікарня' },
        { de: 'die Schule, -n', uk: 'школа' },
        { de: 'die Universität, -en', uk: 'університет' },
        { de: 'der Kollege / die Kollegin', uk: 'колега' },
        { de: 'der Chef / die Chefin', uk: 'керівник / керівниця' },
        { de: 'verdienen', uk: 'заробляти' },
      ],
    },
    {
      group: 'Дієслова щоденних дій',
      items: [
        { de: 'machen', uk: 'робити', ex: 'Was machst du?', exUk: 'Що ти робиш?' },
        { de: 'fahren', uk: 'їхати', ex: 'Er fährt nach Berlin.', exUk: 'Він їде до Берліна.' },
        { de: 'sprechen', uk: 'говорити', ex: 'Sie spricht gut Deutsch.' },
        { de: 'lesen', uk: 'читати', ex: 'Er liest ein Buch.' },
        { de: 'essen', uk: 'їсти', ex: 'Was isst du?' },
        { de: 'trinken', uk: 'пити', ex: 'Ich trinke Kaffee.' },
        { de: 'schlafen', uk: 'спати', ex: 'Das Kind schläft.' },
        { de: 'sehen', uk: 'бачити, дивитися', ex: 'Sie sieht fern.', exUk: 'Вона дивиться телевізор.' },
        { de: 'nehmen', uk: 'брати', ex: 'Ich nehme den Bus.' },
        { de: 'helfen', uk: 'допомагати' },
        { de: 'wissen', uk: 'знати (факт)', ex: 'Ich weiß es nicht.', exUk: 'Я цього не знаю. (ich weiß, du weißt, er weiß)' },
        { de: 'kennen', uk: 'знати (когось/щось)', ex: 'Kennst du Anna?' },
      ],
    },
    {
      group: 'Корисні слова',
      items: [
        ...
        { de: 'gern', uk: 'охоче, із задоволенням', ex: 'Ich lese gern.', exUk: 'Я люблю читати.' },
        { de: 'immer / oft / manchmal / nie', uk: 'завжди / часто / іноді / ніколи' },
        { de: 'heute / morgen / jetzt', uk: 'сьогодні / завтра / зараз' },
        { de: 'die Zeit', uk: 'час' },
        { de: 'die Arbeit', uk: 'робота' },
        { de: 'der Tag, -e', uk: 'день' },
      ],
    },
  ],
  ...
  vocab: [
    ...
    },
    {
      ...
      items: [
        ...
        { de: 'das Sofa, -s', uk: 'диван' },
        { de: 'die Lampe, -n', uk: 'лампа' },
        { de: 'der Kühlschrank', uk: 'холодильник' },
        { de: 'der Herd, -e', uk: 'плита' },
        { de: 'das Fenster, -', uk: 'вікно' },
        { de: 'die Tür, -en', uk: 'двері' },
        { de: 'das Buch, ¨-er', uk: 'книжка' },
        { de: 'der Computer, -', uk: 'комп’ютер' },
      ],
    },
    {
      group: 'Їжа та покупки',
      items: [
        ...
        { de: 'der Kaffee', uk: 'кава' },
        { de: 'der Supermarkt, ¨-e', uk: 'супермаркет' },
        { de: 'kaufen', uk: 'купувати', ex: 'Ich kaufe einen Kühlschrank.' },
        { de: 'brauchen', uk: 'потребувати', ex: 'Wir brauchen keine Lampe.' },
        { de: 'suchen', uk: 'шукати', ex: 'Ich suche eine Wohnung.' },
        { de: 'kosten', uk: 'коштувати', ex: 'Was kostet das?' },
        { de: 'teuer / billig', uk: 'дорогий / дешевий' },
        { de: 'es gibt', uk: 'є, існує', ex: 'Hier gibt es einen Park.' },
      ],
    },
  ],
  ...
  vocab: [
    {
      ...
      items: [
        ...
        { de: 'die Eltern (Pl.)', uk: 'батьки', ex: 'Meine Eltern wohnen in Kyjiw.' },
        ...
        { de: 'der Opa / der Großvater', uk: 'дідусь' },
        { de: 'die Oma / die Großmutter', uk: 'бабуся' },
        { de: 'das Kind, -er', uk: 'дитина' },
        { de: 'der Mann, ¨-er', uk: 'чоловік' },
        { de: 'die Frau, -en', uk: 'жінка, дружина' },
        { de: 'der Freund / die Freundin', uk: 'друг / подруга, хлопець / дівчина' },
      ],
    },
    {
      group: 'Сімейний стан і опис',
      items: [
        { de: 'ledig', uk: 'неодружений / незаміжня' },
        { de: 'verheiratet', uk: 'одружений / заміжня', ex: 'Ich bin verheiratet und habe zwei Kinder.' },
        { de: 'geschieden', uk: 'розлучений' },
        { de: 'jung / alt', uk: 'молодий / старий' },
        { de: 'groß / klein', uk: 'великий, високий / малий' },
        { de: 'nett / freundlich', uk: 'милий / привітний' },
        { de: 'lustig', uk: 'веселий' },
        { de: 'ruhig', uk: 'спокійний, тихий' },
        { de: 'streng', uk: 'суворий' },
        { de: 'sympathisch', uk: 'симпатичний, приємний' },
        { de: 'zusammen', uk: 'разом' },
        { de: 'allein', uk: 'сам, самотньо' },
      ],
    },
    {
      group: 'Сполучники та частки',
      items: [
        { de: 'und', uk: 'і' },
        { de: 'aber', uk: 'але' },
        { de: 'oder', uk: 'або' },
        { de: 'denn', uk: 'бо, тому що' },
        { de: 'sondern', uk: 'а, натомість (після заперечення)' },
        { de: 'auch', uk: 'також' },
        { de: 'noch', uk: 'ще' },
        { de: 'schon', uk: 'вже' },
  ...
  vocab: [
    {
      group: 'Час і дні',
      items: [
        { de: 'die Uhr, -en', uk: 'година; годинник', ex: 'Wie spät ist es?' },
        { de: 'die Stunde, -n', uk: 'година (тривалість)' },
        { de: 'die Minute, -n', uk: 'хвилина' },
        { de: 'die Woche, -n', uk: 'тиждень' },
        { de: 'das Wochenende', uk: 'вихідні', ex: 'am Wochenende', exUk: 'на вихідних' },
        { de: 'der Morgen / der Vormittag', uk: 'ранок / перша половина дня' },
        { de: 'der Mittag / der Nachmittag', uk: 'полудень / друга половина дня' },
        { de: 'der Abend / die Nacht', uk: 'вечір / ніч' },
        { de: 'Viertel nach / Viertel vor', uk: 'чверть по / за чверть' },
        { de: 'halb', uk: 'пів (до наступної години!)' },
        { de: 'früh / spät', uk: 'рано / пізно' },
        { de: 'pünktlich', uk: 'вчасно, пунктуально' },
      ],
    },
    {
      group: 'Дієслова з відокремлюваним префіксом',
      items: [
        { de: 'aufstehen', uk: 'вставати', ex: 'Ich stehe um 6 Uhr auf.' },
        { de: 'anfangen', uk: 'починатися', ex: 'Der Kurs fängt um 9 an.' },
        { de: 'aufhören', uk: 'закінчуватися, припиняти' },
        { de: 'einkaufen', uk: 'робити покупки', ex: 'Am Samstag kaufe ich ein.' },
        { de: 'anrufen', uk: 'телефонувати', ex: 'Ruf mich bitte an!' },
        { de: 'fernsehen', uk: 'дивитися телевізор', ex: 'Am Abend sehe ich fern.' },
        { de: 'mitkommen', uk: 'іти разом', ex: 'Kommst du mit?' },
        { de: 'abholen', uk: 'забирати (когось)', ex: 'Ich hole dich um 8 ab.' },
        { de: 'ausgehen', uk: 'виходити в місто, розважатися' },
        { de: 'zurückkommen', uk: 'повертатися' },
      ],
    },
    {
      group: 'Розпорядок дня',
      items: [
        { de: 'frühstücken', uk: 'снідати' },
        { de: 'zu Mittag essen', uk: 'обідати' },
        { de: 'zu Abend essen', uk: 'вечеряти' },
        { de: 'duschen', uk: 'приймати душ' },
        { de: 'ins Bett gehen', uk: 'лягати спати' },
        { de: 'zur Arbeit gehen / fahren', uk: 'іти / їхати на роботу' },
        { de: 'nach Hause gehen', uk: 'іти додому' },
        { de: 'zu Hause sein', uk: 'бути вдома' },
        { de: 'die Freizeit', uk: 'вільний час' },
        { de: 'der Termin, -e', uk: 'призначена зустріч, прийом' },
        { de: 'Zeit haben', uk: 'мати час' },
        { de: 'sich treffen / treffen', uk: 'зустрічатися', ex: 'Wir treffen uns um sieben.' },
      ],
    },
  ],
