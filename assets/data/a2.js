export default {
  intro:
    'Рівень A2 — це перехід від окремих фраз до зв’язної розповіді. Ви вчитеся пояснювати причини, ' +
    'переказувати чужі слова, описувати предмети прикметниками й розповідати про минуле двома часами. ' +
    'Нижче — два ключових модулі рівня; решта додається.',
...
<tr><td><strong>Sprechen</strong></td><td>Розповісти про себе за ключовими словами, поставити питання партнерові, разом щось спланувати.</td><td>15 хв</td></tr>
  ...
  planned: [
    'Модуль 3: Präteritum сильних дієслів і оповідь про минуле',
    'Модуль 4: Reflexive Verben та Verben mit Präpositionen',
    'Модуль 5: Wechselpräpositionen поглиблено, Genitiv (перше знайомство)',
    'Модуль 6: Konjunktiv II — würde, könnte, hätte для ввічливості',
    'Модуль 7: Relativsätze в Nominativ і Akkusativ',
    'Модуль 8: Комплексний тест рівня A2 у форматі Goethe / ÖSD',
  ],
