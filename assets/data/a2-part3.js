...
<tr><td><em>an deiner Stelle</em></td><td>на твоєму місці</td><td>початок поради</td></tr>
  ...
  vocab: [
    {
      group: 'Ввічливі прохання',
      items: [
        { de: 'Könnten Sie …?', uk: 'Чи могли б Ви …?' },
        { de: 'Würden Sie …?', uk: 'Ви б …?' },
        { de: 'Ich hätte gern …', uk: 'Я хотів би …' },
        { de: 'Ich würde gern …', uk: 'Я б охоче …' },
        { de: 'Wäre es möglich …?', uk: 'Чи було б можливо …?' },
        { de: 'Dürfte ich …?', uk: 'Чи можу я …?' },
        { de: 'Entschuldigung, …', uk: 'Перепрошую, …' },
        { de: 'Vielen Dank im Voraus.', uk: 'Заздалегідь дякую.' },
        { de: 'Das wäre sehr nett.', uk: 'Це було б дуже мило.' },
        { de: 'Kein Problem.', uk: 'Без проблем.' },
      ],
    },
    {
      group: 'У кафе та магазині',
      items: [
        { de: 'die Speisekarte', uk: 'меню' },
        { de: 'bestellen', uk: 'замовляти' },
        { de: 'zahlen / bezahlen', uk: 'платити' },
        { de: 'die Rechnung, -en', uk: 'рахунок' },
        { de: 'zusammen / getrennt', uk: 'разом / окремо' },
        { de: 'das Trinkgeld', uk: 'чайові' },
        { de: 'die Tüte, -n', uk: 'пакет' },
        { de: 'die Kasse, -n', uk: 'каса' },
        { de: 'mit Karte zahlen', uk: 'платити картою' },
        { de: 'Stimmt so.', uk: 'Решти не треба.' },
      ],
    },
    {
      group: 'Домовленості',
      items: [
        { de: 'der Termin, -e', uk: 'прийом, зустріч' },
        { de: 'einen Termin vereinbaren', uk: 'домовитися про зустріч' },
        { de: 'verschieben', uk: 'переносити' },
        { de: 'absagen', uk: 'скасовувати' },
        { de: 'passen', uk: 'підходити (про час)' },
        { de: 'frei sein', uk: 'бути вільним' },
        { de: 'wiederholen', uk: 'повторювати' },
        { de: 'langsamer sprechen', uk: 'говорити повільніше' },
        { de: 'buchstabieren', uk: 'диктувати по літерах' },
        { de: 'die Anmeldung', uk: 'реєстратура, запис' },
      ],
    },
  ],
  ...
  vocab: [
    {
      ...
      items: [
        ...
        { de: 'geduldig', uk: 'терплячий' },
        { de: 'vertrauen + Dat.', uk: 'довіряти' },
        { de: 'kennenlernen', uk: 'знайомитися' },
      ],
    },
    {
      group: 'Опис речей',
      items: [
        ...
        { de: 'langweilig', uk: 'нудний' },
        { de: 'nützlich', uk: 'корисний' },
        { de: 'teuer / günstig', uk: 'дорогий / вигідний' },
        { de: 'gebraucht / neu', uk: 'уживаний / новий' },
        { de: 'kaputt', uk: 'зламаний' },
        { de: 'empfehlen', uk: 'радити' },
        { de: 'gehören + Dat.', uk: 'належати' },
        { de: 'funktionieren', uk: 'працювати (про річ)' },
        { de: 'zu Ende sein', uk: 'закінчитися' },
      ],
    },
    {
      group: 'Місце й оточення',
      items: [
        { de: 'die Gegend, -en', uk: 'район, місцевість' },
        { de: 'das Viertel, -', uk: 'квартал' },
        { de: 'der Ort, -e', uk: 'місце, населений пункт' },
        { de: 'in der Nähe von', uk: 'поблизу' },
        { de: 'ruhig / laut', uk: 'тихий / гучний' },
        { de: 'zentral', uk: 'у центрі' },
        { de: 'der Nachbar von oben', uk: 'сусід згори' },
        { de: 'die Umgebung', uk: 'околиця' },
        { de: 'sich wohlfühlen', uk: 'почуватися добре' },
      ],
    },
  ],
...
<tr><td><em>vergleichen</em></td><td>порівнювати</td><td>назва самої дії</td></tr>
  ...
  vocab: [
    {
      group: 'Прикметники для порівняння',
      items: [
        { de: 'groß — größer — am größten', uk: 'великий — більший — найбільший' },
        { de: 'klein — kleiner — am kleinsten', uk: 'малий — менший — найменший' },
        { de: 'alt — älter — am ältesten', uk: 'старий — старший' },
        { de: 'jung — jünger — am jüngsten', uk: 'молодий — молодший' },
        { de: 'teuer — teurer — am teuersten', uk: 'дорогий — дорожчий' },
        { de: 'billig — billiger — am billigsten', uk: 'дешевий — дешевший' },
        { de: 'schnell — schneller', uk: 'швидкий — швидший' },
        { de: 'gut — besser — am besten', uk: 'добрий — краще — найкраще' },
        { de: 'viel — mehr — am meisten', uk: 'багато — більше — найбільше' },
        { de: 'gern — lieber — am liebsten', uk: 'охоче — охочіше — найохочіше' },
        { de: 'hoch — höher — am höchsten', uk: 'високий — вищий' },
        { de: 'nah — näher — am nächsten', uk: 'близький — ближчий' },
      ],
    },
    {
      group: 'Порівняння й вибір',
      items: [
        { de: 'als', uk: 'за, ніж (після вищого ступеня)' },
        { de: 'so … wie', uk: 'такий самий, як' },
        { de: 'nicht so … wie', uk: 'не такий, як' },
        { de: 'vergleichen', uk: 'порівнювати' },
        { de: 'der Unterschied, -e', uk: 'різниця' },
        { de: 'der Vorteil / der Nachteil', uk: 'перевага / недолік' },
        { de: 'sich entscheiden für + Akk.', uk: 'обирати на користь' },
        { de: 'lieber', uk: 'краще, охочіше' },
        { de: 'am besten', uk: 'найкраще' },
        { de: 'ungefähr', uk: 'приблизно' },
      ],
    },
    {
      group: 'Подорож і покупки — для порівнянь',
      items: [
        { de: 'der Flug, ¨-e', uk: 'переліт' },
        { de: 'die Fahrt, -en', uk: 'поїздка' },
        { de: 'dauern', uk: 'тривати' },
        { de: 'kosten', uk: 'коштувати' },
        { de: 'bequem / unbequem', uk: 'зручний / незручний' },
        { de: 'pünktlich', uk: 'вчасний' },
        { de: 'umsteigen', uk: 'пересідати' },
        { de: 'sparen', uk: 'заощаджувати' },
        { de: 'die Verbindung, -en', uk: 'сполучення' },
