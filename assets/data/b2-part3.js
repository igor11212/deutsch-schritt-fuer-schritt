...
<tr><td><em>zeitnah</em></td><td>своєчасно, невідкладно</td><td><em>Eine zeitnahe Entscheidung …</em></td></tr>
  ...
  vocab: [
    {
      group: 'Дієслова з прийменником (B2)',
      items: [
        { de: 'hinweisen auf + Akk.', uk: 'указувати на' },
        { de: 'bestehen auf + Dat.', uk: 'настоювати на' },
        { de: 'bestehen aus + Dat.', uk: 'складатися з' },
        { de: 'bestehen in + Dat.', uk: 'полягати в' },
        { de: 'ausgehen von + Dat.', uk: 'припускати, виходити з' },
        { de: 'abhängen von + Dat.', uk: 'залежати від' },
        { de: 'verzichten auf + Akk.', uk: 'відмовлятися від' },
        { de: 'zweifeln an + Dat.', uk: 'сумніватися в' },
        { de: 'beitragen zu + Dat.', uk: 'сприяти' },
        { de: 'führen zu + Dat.', uk: 'призводити до' },
        { de: 'sich einigen auf + Akk.', uk: 'домовлятися про' },
        { de: 'es handelt sich um + Akk.', uk: 'ідеться про' },
      ],
    },
    {
      ...
      items: [
        ...
        { de: 'einen Vertrag abschließen', uk: 'укласти договір' },
        { de: 'in Betracht ziehen', uk: 'враховувати' },
        { de: 'Maßnahmen ergreifen', uk: 'уживати заходів' },
      ],
    },
    {
      group: 'Проєкти й співпраця',
      items: [
        { de: 'die Zusammenarbeit', uk: 'співпраця' },
        { de: 'die Absprache, -n', uk: 'домовленість' },
        { de: 'der Zeitplan, ¨-e', uk: 'графік' },
        { de: 'die Zuständigkeit, -en', uk: 'сфера відповідальності' },
        { de: 'der Aufwand', uk: 'витрати сил, ресурси' },
        { de: 'die Umsetzung', uk: 'втілення' },
        { de: 'das Ziel erreichen', uk: 'досягти цілі' },
        { de: 'sich abstimmen mit + Dat.', uk: 'узгоджувати з' },
        { de: 'zeitnah', uk: 'своєчасно' },
        { de: 'verbindlich', uk: 'обов’язковий' },
      ],
    },
  ],
...
<tr><td><em>einführen</em></td><td>запроваджувати</td><td><em>Die Regel wurde eingeführt.</em></td></tr>
  ...
  vocab: [
    {
      group: 'Дієслова процесів',
      items: [
        { de: 'einführen', uk: 'запроваджувати' },
        { de: 'beschließen', uk: 'ухвалювати' },
        { de: 'umsetzen', uk: 'втілювати' },
        { de: 'überprüfen', uk: 'перевіряти' },
        { de: 'genehmigen', uk: 'схвалювати' },
        { de: 'abschaffen', uk: 'скасовувати' },
        { de: 'ersetzen', uk: 'заміняти' },
        { de: 'erweitern', uk: 'розширювати' },
        { de: 'sanieren', uk: 'реконструювати' },
        { de: 'zerstören', uk: 'руйнувати' },
        { de: 'die Maßnahme, -n', uk: 'заходи' },
        { de: 'die Verordnung, -en', uk: 'розпорядження, постанова' },
      ],
    },
    {
      group: 'Правила й заборони',
      items: [
        { de: 'Es wird gebeten, …', uk: 'Просимо …' },
        { de: 'Es ist untersagt', uk: 'Заборонено' },
        { de: 'verboten / erlaubt', uk: 'заборонено / дозволено' },
        { de: 'die Vorschrift, -en', uk: 'припис, правило' },
        { de: 'die Pflicht, -en', uk: 'обов’язок' },
        { de: 'verpflichtet sein zu + Dat.', uk: 'бути зобов’язаним' },
        { de: 'genehmigungspflichtig', uk: 'той, що вимагає дозволу' },
        { de: 'zulässig', uk: 'допустимий' },
        { de: 'die Ausnahme, -n', uk: 'виняток' },
        { de: 'gelten', uk: 'бути чинним' },
      ],
    },
    {
      group: 'Місто й інфраструктура',
      items: [
        { de: 'die Baustelle, -n', uk: 'будмайданчик' },
        { de: 'die Sanierung, -en', uk: 'реконструкція' },
        { de: 'die Fußgängerzone, -n', uk: 'пішохідна зона' },
        { de: 'der Radweg, -e', uk: 'велодоріжка' },
        { de: 'die Anwohner (Pl.)', uk: 'мешканці (околиці)' },
        { de: 'der Lärmschutz', uk: 'захист від шуму' },
        { de: 'die Grünfläche, -n', uk: 'зелена зона' },
        { de: 'errichten', uk: 'зводити, споруджувати' },
        { de: 'die Genehmigung, -en', uk: 'дозвіл' },
        { de: 'die Bürgerbeteiligung', uk: 'участь громадян' },
      ],
    },
  ],
...
<tr><td><em>der Bau</em></td><td>будівництво</td><td><em>Dennoch beginnt der Bau.</em></td></tr>
  ...
  vocab: [
    {
      group: 'Конектори за функцією',
      items: [
        { de: 'deshalb / folglich', uk: 'тому / отже' },
        { de: 'trotzdem / dennoch', uk: 'та все ж / проте' },
        { de: 'außerdem / zudem', uk: 'крім того / до того ж' },
        { de: 'allerdings / jedoch', uk: 'щоправда / однак' },
        ...
        { de: 'demnach', uk: 'відповідно, звідси' },
      ],
    },
    {
      group: 'Слова для стиснення думки',
      items: [
        { de: 'dieser Umstand', uk: 'ця обставина' },
        { de: 'diese Entwicklung', uk: 'ця динаміка' },
        { de: 'dieses Versäumnis', uk: 'цей недогляд' },
        { de: 'diese Maßnahme', uk: 'цей захід' },
        { de: 'der genannte Punkt', uk: 'згаданий пункт' },
        { de: 'das eigentliche Problem', uk: 'справжня проблема' },
        { de: 'die Folge davon', uk: 'наслідок цього' },
        { de: 'aus diesem Grund', uk: 'із цієї причини' },
        { de: 'in diesem Zusammenhang', uk: 'у цьому зв’язку' },
        { de: 'vor diesem Hintergrund', uk: 'на цьому тлі' },
      ],
    },
    {
      group: 'Обставини часу й способу',
      items: [
        { de: 'inzwischen', uk: 'тим часом' },
        { de: 'zunächst', uk: 'спершу' },
        { de: 'anschließend', uk: 'потім, після цього' },
        { de: 'gleichzeitig', uk: 'одночасно' },
        { de: 'allmählich', uk: 'поступово' },
        { de: 'sorgfältig', uk: 'ретельно' },
        { de: 'absichtlich', uk: 'навмисно' },
        { de: 'versehentlich', uk: 'ненавмисно, помилково' },
        { de: 'ausdrücklich', uk: 'прямо, чітко' },
        { de: 'weitgehend', uk: 'значною мірою' },
      ],
    },
  ],
