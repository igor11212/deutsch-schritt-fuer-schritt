...
<tr><td><em>das Vorhaben, -</em></td><td>задум, план</td><td><em>… von dem Vorhaben Abstand zu nehmen.</em></td></tr>
  ...
  vocab: [
    {
      group: 'Звороти з nehmen і ziehen',
      items: [
        { de: 'Rücksicht nehmen auf + Akk.', uk: 'зважати на' },
        { de: 'Abstand nehmen von + Dat.', uk: 'відступитися від' },
        { de: 'Einfluss nehmen auf + Akk.', uk: 'впливати на' },
        { de: 'zur Kenntnis nehmen', uk: 'брати до відома' },
        ...
        { de: 'Konsequenzen ziehen', uk: 'робити висновки, вживати наслідків' },
        { de: 'Bilanz ziehen', uk: 'підводити підсумок' },
      ],
    },
    {
      group: 'Звороти з bringen, stellen, leisten',
      items: [
        { de: 'zum Ausdruck bringen', uk: 'висловлювати' },
        { de: 'zur Sprache bringen', uk: 'порушувати (тему)' },
        { de: 'in Erfahrung bringen', uk: 'дізнатися' },
        { de: 'in Frage stellen', uk: 'ставити під сумнів' },
        { de: 'zur Verfügung stellen', uk: 'надавати в розпорядження' },
        { de: 'unter Beweis stellen', uk: 'доводити на практиці' },
        { de: 'Bedingungen stellen', uk: 'висувати умови' },
        { de: 'Folge leisten + Dat.', uk: 'виконувати вимогу' },
        { de: 'Widerstand leisten', uk: 'чинити опір' },
        { de: 'einen Beitrag leisten zu + Dat.', uk: 'робити внесок у' },
      ],
    },
    {
      group: 'Звороти з erheben, tragen, finden',
      items: [
        { de: 'Anspruch erheben auf + Akk.', uk: 'заявляти претензію на' },
        { de: 'Einspruch erheben', uk: 'подавати заперечення' },
        { de: 'Klage erheben', uk: 'подавати позов' },
        { de: 'Rechnung tragen + Dat.', uk: 'враховувати' },
        { de: 'Verantwortung tragen für + Akk.', uk: 'нести відповідальність за' },
        { de: 'Sorge tragen für + Akk.', uk: 'дбати про' },
        { de: 'Anwendung finden', uk: 'застосовуватися' },
        { de: 'Zustimmung finden', uk: 'здобувати підтримку' },
        { de: 'Berücksichtigung finden', uk: 'бути врахованим' },
...
<tr><td><em>der Beitrag, ¨-e</em></td><td>внесок</td><td>Останній корінь у <em>Krankenversicherungsbeitrag</em>.</td></tr>
  ...
  vocab: [
    {
      group: 'Дієслова з префіксами',
      items: [
        { de: 'beantworten', uk: 'відповідати на щось' },
        { de: 'bearbeiten', uk: 'опрацьовувати' },
        { de: 'verbessern', uk: 'покращувати' },
        { de: 'verschwinden', uk: 'зникати' },
        { de: 'entdecken', uk: 'відкривати, виявляти' },
        { de: 'entlassen', uk: 'звільняти з роботи' },
        { de: 'zerstören', uk: 'руйнувати' },
        { de: 'erkennen', uk: 'розпізнавати' },
        { de: 'missverstehen', uk: 'не так зрозуміти' },
        { de: 'übersehen', uk: 'не помітити' },
        { de: 'unterschätzen', uk: 'недооцінювати' },
        { de: 'übertreiben', uk: 'перебільшувати' },
      ],
    },
    {
      group: 'Абстрактні іменники',
      items: [
        { de: 'die Gelassenheit', uk: 'врівноваженість' },
        { de: 'die Zuverlässigkeit', uk: 'надійність' },
        { de: 'die Gerechtigkeit', uk: 'справедливість' },
        { de: 'die Verantwortung', uk: 'відповідальність' },
        { de: 'das Verhältnis, -se', uk: 'співвідношення; стосунки' },
        { de: 'das Ergebnis, -se', uk: 'результат' },
        { de: 'die Gesellschaft, -en', uk: 'суспільство' },
        { de: 'die Bereitschaft', uk: 'готовність' },
        { de: 'das Wachstum', uk: 'зростання' },
        { de: 'die Beschränkung, -en', uk: 'обмеження' },
      ],
    },
    {
      group: 'Прикметники за суфіксом',
      items: [
        { de: 'zweifelhaft', uk: 'сумнівний' },
        { de: 'vorteilhaft', uk: 'вигідний' },
        { de: 'fehlerhaft', uk: 'помилковий' },
        { de: 'aufmerksam', uk: 'уважний' },
        { de: 'sparsam', uk: 'ощадливий' },
        { de: 'kindlich / kindisch', uk: 'дитячий / інфантильний' },
        { de: 'geistig / geistlich', uk: 'розумовий / духовний' },
        { de: 'monatlich', uk: 'щомісячний' },
        { de: 'grundsätzlich', uk: 'принциповий' },
        { de: 'nachträglich', uk: 'пізніший, зроблений потім' },
      ],
    },
  ],
...
<tr><td><em>der Ersatztermin, -e</em></td><td>альтернативна дата</td><td><em>… um Mitteilung eines Ersatztermins wird gebeten.</em></td></tr>
  ...
  vocab: [
    {
      group: 'Офіційні відповідники',
      items: [
        { de: 'erfolgen', uk: 'відбуватися' },
        { de: 'vorliegen', uk: 'бути наявним' },
        { de: 'wahrnehmen', uk: 'скористатися, відбути' },
        { de: 'zurückzuführen sein auf + Akk.', uk: 'бути зумовленим' },
        { de: 'Kenntnis erlangen von + Dat.', uk: 'дізнатися про' },
        { de: 'hinsichtlich + Gen.', uk: 'щодо' },
        { de: 'bezüglich + Gen.', uk: 'стосовно' },
        { de: 'gemäß + Dat.', uk: 'згідно з' },
        { de: 'laut + Dat.', uk: 'за (словами)' },
        { de: 'im Rahmen + Gen.', uk: 'у межах' },
      ],
    },
    {
      group: 'Введення чужої думки',
      items: [
        { de: 'feststellen', uk: 'констатувати' },
        { de: 'betonen', uk: 'наголошувати' },
        { de: 'behaupten', uk: 'стверджувати (сумнівно)' },
        { de: 'einräumen', uk: 'визнавати' },
        { de: 'bezweifeln', uk: 'сумніватися в' },
        { de: 'zufolge + Dat.', uk: 'за словами' },
        { de: 'nach Ansicht von + Dat.', uk: 'на думку' },
        { de: 'sich berufen auf + Akk.', uk: 'посилатися на' },
        { de: 'zitieren', uk: 'цитувати' },
        { de: 'wiedergeben', uk: 'переказувати, відтворювати' },
      ],
    },
    {
      group: 'Розмовне проти книжного',
      items: [
        { de: 'platzen ↔ nicht stattfinden', uk: 'зірватися ↔ не відбутися' },
