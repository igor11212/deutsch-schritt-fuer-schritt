...
<tr><td><em>der Wendepunkt, -e</em></td><td>переломний момент</td><td>Тема письмового завдання цього модуля.</td></tr>
  ...
  vocab: [
    {
      group: 'Час і послідовність',
      items: [
        { de: 'zuerst — dann — danach — schließlich', uk: 'спершу — потім — після того — нарешті' },
        { de: 'gleichzeitig', uk: 'одночасно' },
        { de: 'inzwischen / mittlerweile', uk: 'тим часом; на цей час' },
        { de: 'vorher / nachher', uk: 'перед тим / після того' },
        { de: 'damals', uk: 'тоді, у ті часи' },
        { de: 'plötzlich', uk: 'раптом' },
        { de: 'sofort', uk: 'негайно' },
        { de: 'endlich', uk: 'нарешті' },
        { de: 'seitdem', uk: 'з того часу' },
        { de: 'bis dahin', uk: 'до того моменту' },
      ],
    },
    {
      group: 'Життєвий шлях (Lebenslauf)',
      items: [
        { de: 'die Ausbildung, -en', uk: 'фахове навчання, освіта' },
        { de: 'das Studium (Pl. Studien)', uk: 'навчання у вищому закладі' },
        { de: 'der Abschluss, ¨-e', uk: 'диплом, завершення навчання' },
        { de: 'sich bewerben um + Akk.', uk: 'подавати заявку на' },
        { de: 'die Stelle, -n', uk: 'посада, робоче місце' },
        { de: 'kündigen', uk: 'звільнятися; розривати договір' },
    ...
    {
      group: 'Дієслова перебігу подій',
      items: [
        { de: 'beginnen / anfangen', uk: 'починати(ся)' },
        { de: 'aufhören', uk: 'припиняти(ся)' },
        { de: 'dauern', uk: 'триває, тягнеться' },
        { de: 'verlaufen', uk: 'відбуватися, проходити' },
        { de: 'passieren / geschehen', uk: 'ставатися' },
        { de: 'sich ereignen', uk: 'відбуватися (про подію)' },
        { de: 'ankommen', uk: 'прибувати' },
        { de: 'abfahren', uk: 'відʼїжджати' },
        { de: 'warten, bis …', uk: 'чекати, доки …' },
        { de: 'verschieben', uk: 'переносити (у часі)' },
      ],
    },
  ],
...
<tr><td><em>der Zweck, -e</em></td><td>мета, призначення</td><td><em>Wozu? — Zu welchem Zweck?</em></td></tr>
  ...
  vocab: [
    {
      group: 'Дієслова, що вимагають zu',
      items: [
        { de: 'versuchen, … zu …', uk: 'намагатися' },
        { de: 'vorhaben, … zu …', uk: 'планувати' },
        { de: 'beschließen, … zu …', uk: 'вирішувати, ухвалювати рішення' },
        { de: 'vergessen, … zu …', uk: 'забути' },
        { de: 'hoffen, … zu …', uk: 'сподіватися' },
        { de: 'anfangen / aufhören, … zu …', uk: 'починати / припиняти' },
        { de: 'sich weigern, … zu …', uk: 'відмовлятися' },
        { de: 'jemanden bitten, … zu …', uk: 'просити когось' },
        { de: 'vorschlagen, … zu …', uk: 'пропонувати' },
        { de: 'sich bemühen, … zu …', uk: 'старатися, докладати зусиль' },
      ],
    },
    {
      group: 'Мета й намір',
      items: [
        { de: 'der Zweck, -e', uk: 'мета, призначення' },
        { de: 'das Ziel, -e', uk: 'ціль' },
        { de: 'die Absicht, -en', uk: 'намір' },
        { de: 'absichtlich', uk: 'навмисно' },
        { de: 'deswegen / deshalb', uk: 'тому, через це' },
        { de: 'wozu?', uk: 'для чого?' },
        { de: 'damit', uk: 'щоб (різні підмети)' },
        { de: 'um … zu', uk: 'щоб (той самий підмет)' },
        { de: 'erreichen', uk: 'досягати' },
        { de: 'sich vornehmen', uk: 'ставити собі за мету' },
      ],
    },
    {
      group: 'Плани та щоденні справи',
      items: [
        { de: 'sich etwas leisten', uk: 'дозволити собі' },
        { de: 'sparen', uk: 'заощаджувати' },
        { de: 'das Konto eröffnen', uk: 'відкрити рахунок' },
        { de: 'einen Termin absagen', uk: 'скасувати зустріч' },
        { de: 'das Formular ausfüllen', uk: 'заповнити формуляр' },
        { de: 'die Unterlagen (Pl.)', uk: 'документи, папери' },
        { de: 'sich anmelden', uk: 'реєструватися' },
        { de: 'sich erkundigen nach + Dat.', uk: 'дізнаватися про' },
        { de: 'rechtzeitig', uk: 'вчасно' },
...
<tr><td><em>der Ansprechpartner, -</em></td><td>контактна особа</td><td>Слово з письмового завдання цього модуля.</td></tr>
  ...
  vocab: [
    {
      group: 'Дієслова з прийменником',
      items: [
        { de: 'warten auf + Akk.', uk: 'чекати на' },
        { de: 'denken an + Akk.', uk: 'думати про' },
        { de: 'sich freuen auf + Akk.', uk: 'з нетерпінням чекати' },
        ...
        { de: 'sich erinnern an + Akk.', uk: 'пам’ятати, згадувати' },
        { de: 'sich entschuldigen für + Akk.', uk: 'вибачатися за' },
        { de: 'sich beschäftigen mit + Dat.', uk: 'займатися чимось' },
      ],
    },
    {
      group: 'Питати й уточнювати',
      items: [
        { de: 'Könnten Sie mir sagen, …?', uk: 'Чи могли б Ви мені сказати …?' },
        { de: 'Wissen Sie zufällig, …?', uk: 'Чи не знаєте випадково …?' },
        { de: 'Ich würde gern wissen, …', uk: 'Я хотів би знати …' },
        { de: 'Mich würde interessieren, …', uk: 'Мене цікавило б …' },
        { de: 'Darf ich fragen, ob …?', uk: 'Чи можу я запитати, чи …?' },
        { de: 'Eine kurze Frage: …', uk: 'Коротке запитання: …' },
        { de: 'nachfragen', uk: 'перепитувати, уточнювати' },
        { de: 'sich erkundigen nach + Dat.', uk: 'дізнаватися про' },
        { de: 'der Ansprechpartner, -', uk: 'контактна особа' },
        { de: 'die Auskunft, ¨-e', uk: 'довідка, інформація' },
      ],
    },
    {
      group: 'Курси й записи',
      items: [
        { de: 'die Anmeldung, -en', uk: 'реєстрація, запис' },
        { de: 'die Teilnahme', uk: 'участь' },
        { de: 'die Gebühr, -en', uk: 'плата, збір' },
        { de: 'der Nachweis, -e', uk: 'підтвердження, довідка' },
        { de: 'die Voraussetzung, -en', uk: 'передумова, вимога' },
        { de: 'stattfinden', uk: 'відбуватися' },
        { de: 'ausfallen', uk: 'скасовуватися, не відбуватися' },
        { de: 'der Rabatt, -e', uk: 'знижка' },
        { de: 'verbindlich', uk: 'обов’язковий, остаточний' },
