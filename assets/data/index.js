...
export const LEVELS = [
  {
    ...
    examWords: '≈ 650 слів', vocab: 326, hours: '≈ 120 годин', status: 'full',
  },
  {
    ...
    examWords: '≈ 1300 слів', vocab: 248, hours: '≈ 200 годин', status: 'full',
  },
  {
    ...
    examWords: '≈ 2400 слів', vocab: 216, hours: '≈ 350 годин', status: 'full',
  },
  {
    ...
    examWords: '≈ 4000 слів', vocab: 193, hours: '≈ 600 годин', status: 'full',
  },
  {
    ...
    examWords: '≈ 6000 слів', vocab: 192, hours: '≈ 800 годин', status: 'full',
  },
];

import { READING } from './reading.js?v=20260819m';
import { SPRECHEN } from './sprechen.js?v=20260819m';
...
export async function loadLevel(id) {
  ...
  const [mod, voc] = await Promise.all([
    import(`./${id}.js?v=20260819m`),
    import(`./vocab-${id}.js?v=20260819m`),
  ]);
  const level = {
    ...mod.default,
    reading: READING[id] || [],
