...
import { el, renderExerciseSet } from './exercises.js?v=20260819h';
import { speakDialogue, stop as stopSpeech, ttsSupported } from './tts.js?v=20260819h';
import { checkWriting } from './writing-check.js?v=20260819h';
import { EXAM, PART_META } from '../data/exam.js?v=20260819h';
import { saveExam } from './progress.js?v=20260819h';
