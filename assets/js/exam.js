...
import { el, renderExerciseSet } from './exercises.js?v=20260819d';
import { speakDialogue, stop as stopSpeech, ttsSupported } from './tts.js?v=20260819d';
import { checkWriting } from './writing-check.js?v=20260819d';
import { EXAM, PART_META } from '../data/exam.js?v=20260819d';
import { saveExam } from './progress.js?v=20260819d';
