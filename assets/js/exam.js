...
import { el, renderExerciseSet } from './exercises.js?v=20260819i';
import { speakDialogue, stop as stopSpeech, ttsSupported } from './tts.js?v=20260819i';
import { checkWriting } from './writing-check.js?v=20260819i';
import { EXAM, PART_META } from '../data/exam.js?v=20260819i';
import { saveExam } from './progress.js?v=20260819i';
